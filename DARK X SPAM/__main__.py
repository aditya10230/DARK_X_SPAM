...
from DARK X SPAM.utils import load_plugins
import logging
...
print("🎉 Dark X Spam Bot Successfully Deployed 🎉 @NARUT0XD")
print("Enjoy! Do visit @DarkX_Spam_bot")
